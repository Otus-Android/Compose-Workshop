package ru.otus.compose.workshop.productcard.start

import androidx.compose.ui.graphics.Color
import kotlinx.collections.immutable.persistentListOf
import ru.otus.compose.workshop.R
import ru.otus.compose.workshop.productcard.start.ProductCardState
import ru.otus.compose.workshop.productcard.start.ProductCardState.ImagesState.ImageState
import ru.otus.compose.workshop.productcard.start.ProductCardState.ColorsState
import ru.otus.compose.workshop.productcard.start.ProductCardState.ColorsState.ColorState
import ru.otus.compose.workshop.productcard.start.ProductCardState.ImagesState
import ru.otus.compose.workshop.productcard.start.ProductCardState.SizesState
